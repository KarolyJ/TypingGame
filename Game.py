...
class Pane(object):
    ...
    def __init__(self):
        ...
        # importing the image
        self.bg_image = pygame.image.load("data/background_img.jpg")
    ...
    def new(self):
        ...
        file_score = open("data/high_score.txt", "r")
    ...
    def gameOver(self):
        ...
        if int(self.high_score) < self.score:
            file_score_writer = open("data/high_score.txt", "w")
